...
def delete_insumo(id_insumo):
    ...
    if insumo:
        ...
        cursor.execute('INSERT INTO insumos_historicos  (id_insumo, nombre_insumo, inventario, unidades, fecha_suministro, cantidad_minima, cantidad_descuento, fecha_borrado) VALUES (%s, %s, %s, %s, %s, NOW())', 
